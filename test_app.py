...
class AgencyTestCase(unittest.TestCase):
  ...
  #============================================================#    
    ...
    def test_error_401_get_all_actors_by_page(self):
        ...
        self.assertEqual(records['message'], 'Authorization Header is Required')

    def test_error_404_get_actors_by_page(self):
        response = self.client().get('/actors?page=3', headers = casting_assistant_auth_header)
        records  = json.loads(response.data)
  ...
  #============================================================# 
    ...
    def test_create_new_actor_with_all_data(self):
        ...
        response = self.client().post('/actors', json = actor_json, headers = casting_director_auth_header)
        records  = json.loads(response.data)
    ...
    def test_error_422_create_new_actor(self):
        ...
        response = self.client().post('/actors', json = actor_without_name, headers = casting_director_auth_header)
        records  = json.loads(response.data)
  ...
  #============================================================# 
    ...
    def test__try_to_edit_actor(self):
        ...
        response = self.client.patch('/actors/1', json = update_with_new_age, headers = casting_director_auth_header)
        records  = json.loads(response.data)
    ...
    def test_error_400_edit_actor(self):
        response = self.client().patch('/actors/2001', headers = casting_director_auth_header)
        records  = json.loads(response.data)
    ...
    def test_error_404_edit_actor_with_unknown_id(self):
        ...
        response = self.client().patch('/actors/20010224', json = actor_with_new_age, headers = casting_director_auth_header)
        records  = json.loads(response.data)

        self.assertEqual(response.status_code, 404)
        self.assertFalse(records['success'])
        self.assertEqual(records['message'] , 'Actor with id 20010224 Not Found.')         
  ...
  #============================================================#            
    ...
    def test_error_404_delete_actor(self):
        response = self.client().delete('/actors/477', headers = casting_director_auth_header)
        records  = json.loads(response.data)
  ...
  #============================================================#  
    ...
    def test_error_404_get_movies_by_page(self):    
        response = self.client().get('/movies?page=24022001', headers = casting_assistant_auth_header)
        records  = json.loads(response.data)
  ...
  #============================================================#         
    def test_create_new_movie(self):
        ...
        response = self.client().post('/movies', json = movie_json, headers = executive_producer_auth_header)
        records  = json.loads(response.data)
    ...
    def test_error_422_create_new_movie_without_title(self):
        ...
        response = self.client().post('/movies', json = movie_without_name, headers = executive_producer_auth_header)
        records  = json.loads(response.data)
  ...
  #============================================================#         
    def test_try_to_edit_movie(self):        
        ...
        response = self.client().patch('/movies/1', json = movie_record, headers = executive_producer_auth_header)
        records  = json.loads(response.data)
    ...
    def test_error_404_edit_movie_by_id(self):    
        ...
        response = self.client().patch('/movies/199121', json = movie_record, headers = executive_producer_auth_header)
        records  = json.loads(response.data)
  ...
  #============================================================#           
    ...
    def test_error_404_delete_movie(self):
        response = self.client().delete('/movies/477', headers = executive_producer_auth_header) 
        records  = json.loads(response.data)

        self.assertEqual(response.status_code, 404)
        self.assertFalse(records['success'])
        self.assertEqual(records['message'] , 'Movie with id 477 not found in database.')
